...
## Packages installed
 ...
 - `php5-apcu`, `php5-cli`, `php5-curl`, `php-gettext`, `php5-gd`, `php5-geoip`, `php5-imagick`, `php5-intl`, `php5-json`, `php5-mcrypt`, `php5-memcached`, `php5-mysqlnd`, `php5-sqlite`, `php5-xdebug`, `php5-xhprof`, `memcached`, `imagemagick`, `openssh-client`, `curl`, `gettext`, `zip`, `git`
